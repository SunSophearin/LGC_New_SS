  ...
  <div>
    <div class="w-full flex items-center flex-wrap justify-center gap-10">
      ...
      <div class="grid gap-4 w-60">
        ...
        <div>
          <h2
            class="text-center text-black dark:text-gray-200 text-xl font-semibold leading-loose pb-2"
          >
            There’s no product here
          </h2>
          <p
            class="text-center text-black dark:text-gray-200 text-base font-normal leading-relaxed pb-4"
          >
